...
NOS.controller('NOSController', function($scope,$http)
    ...
    $scope.TestStart = "";
    $scope.TestEnd = "";
    //$scope.baseURL = "http://192.168.0.7:8181/EasyLauncher/rest/";
    $scope.baseURL = "http://<server:IP>:<PortNo>/EasyLauncher/rest/";
      ...
      .then(function successCallback(response)
	   {
	    ...
	    function errorCallback(response)
		{
		    $scope.requestStatus = "GET Request Failed";
		    $scope.errorPoint = "Error occured during http GET[In function to get list of protocol suites]" ;
