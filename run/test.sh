...
/usr/local/bin/robot --timestampoutputs --log ${test}_Log.html --report ${test}_Report.html --loglevel DEBUG --output ${test}_Output.xml --outputdir ${basePath}/../Results/${test}  $2
